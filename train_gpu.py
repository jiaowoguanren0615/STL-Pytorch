...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'STL-Fan training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=16, type=int)
    parser.add_argument('--epochs', default=2, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='fan_swin_base_patch4_window7_224', type=str, metavar='MODEL',
                        choices=['fan_base_18_p16_224', 'fan_large_24_p16_224', 'fan_large_16_p4_hybrid',
                                'fan_tiny_8_p4_hybrid', 'fan_large_16_p4_hybrid_token', 'fan_tiny_8_p4_hybrid_token',
                                'fan_base_16_p4_hybrid_token', 'fan_base_16_p4_hybrid', 'fan_small_12_p4_hybrid_token',
                                'fan_small_12_p4_hybrid', 'fan_small_12_p16_224', 'fan_tiny_12_p16_224',
                                'fan_Xlarge_16_p4_hybrid', 'fan_small_12_p16_224_se_attn', 'fan_swin_small_patch4_window7_224',
                                'fan_swin_tiny_patch4_window7_224', 'fan_swin_base_patch4_window7_224',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'STL-Fan training and evaluation script', parents=[get_args_parser()])
