...
class FAN(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dim=768, depth=12,
                 ...
                 tokens_norm=False, c_head_num=None, hybrid_patch_size=2, head_init_scale=1.0, return_dense=False,
                 **kwargs):
        ...
        # Add return_dense to get aux_head for all token features
...
# FAN-ViT Models
@register_model
def fan_tiny_12_p16_224(pretrained=False, bn_tf=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 12
...
@register_model
def fan_small_12_p16_224_se_attn(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 12
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_kwargs = dict(
...
@register_model
def fan_small_12_p16_224(pretrained=False, bn_tf=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 12
    sr_ratio = [1] * depth
    model_kwargs = dict(
...
@register_model
def fan_base_18_p16_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 18
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_kwargs = dict(
...
@register_model
def fan_large_24_p16_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 24
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_kwargs = dict(
...
@register_model
def fan_tiny_8_p4_hybrid(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 8
...
@register_model
def fan_small_12_p4_hybrid(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 10
...
@register_model
def fan_base_16_p4_hybrid(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 16
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
    backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
...
@register_model
def fan_large_16_p4_hybrid(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 22
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
...
@register_model
def fan_Xlarge_16_p4_hybrid(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """
...
@register_model
def fan_swin_tiny_patch4_window7_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
# FAN-Swin Models
@register_model
def fan_swin_small_patch4_window7_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
...
@register_model
def fan_swin_base_patch4_window7_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ Swin-S @ 224x224, trained ImageNet-1k
    """
    mlp_type = ['FAN', 'FAN', 'FAN', 'Mlp']
    model_kwargs = dict(
...
@register_model
def fan_swin_large_patch4_window7_224(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    """ Swin-S @ 224x224, trained ImageNet-1k
    """
    mlp_type = ['FAN', 'FAN', 'FAN', 'Mlp']
    model_kwargs = dict(
...
# FAN-Hybrid Models (FAN-v2)
# CNN backbones are based on ConvNeXt architecture with only first two stages for downsampling purpose
# This has been verified to be beneficial for downstream tasks

@register_model
def fan_tiny_8_p4_hybrid_token(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 8
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2 + 1)
    model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
    backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
    model_kwargs = dict(
        patch_size=16, embed_dim=192, depth=depth, num_heads=8, eta=1.0, tokens_norm=True, sharpen_attn=False,
        return_dense=True, **kwargs)
    model = _create_fan('fan_tiny_8_p16_224', pretrained=pretrained, sr_ratio=sr_ratio, backbone=backbone,
                        **model_kwargs)
    return model
...
@register_model
def fan_small_12_p4_hybrid_token(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 10
    channel_dims = [384] * 10 + [384] * (depth - 10)
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
...
@register_model
def fan_base_16_p4_hybrid_token(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 16
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_args = dict(depths=[3, 3], dims=[128, 256, 512, 1024], use_head=False)
    backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
    model_kwargs = dict(
        patch_size=16, embed_dim=448, depth=depth, num_heads=8, eta=1.0, tokens_norm=True, sharpen_attn=False,
        return_dense=True, **kwargs)
    model = _create_fan('fan_base_18_p16_224', pretrained=pretrained, sr_ratio=sr_ratio, backbone=backbone,
                        **model_kwargs)
    return model
...
@register_model
def fan_large_16_p4_hybrid_token(pretrained=False, pretrained_cfg=None, pretrained_cfg_overlay=None, **kwargs):
    depth = 22
    sr_ratio = [1] * (depth // 2) + [1] * (depth // 2)
    model_args = dict(depths=[3, 5], dims=[128, 256, 512, 1024], use_head=False)
    backbone = _create_hybrid_backbone(pretrained=False, pretrained_strict=False, **model_args)
...
#     net = fan_tiny_12_p16_224(num_classes=5)
